...
const checkWinner = function (avgDolphins, avgKoalas) {
  if (avgDolphins >= 2 * avgKoalas){
    console.log(`The Dolphins are the winners with a score of ${avgDolphins} vs ${avgKoalas}`);
  } else if(avgKoalas >= 2 * avgDolphins) {
    console.log(`The Koalas are the winners with a score of ${avgKoalas} vs ${avgDolphins};`)
  } else {
    console.log(`No winner this time, Dolphins with ${avgDolphins} points and Koalas with ${avgKoalas} points.`);
  }
